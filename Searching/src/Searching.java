...
public class Searching {
	public ArrayList<Integer> sequentialSearchN(int data[],int target) { //숫자 배열에서 특정 숫자가 있는 배열의 인덱스를 리턴
	...
	public ArrayList<Integer> sequentialSearchS(String data[],char target) { //단어가 있는 문자열 배열에서 특정 문자가 있는 배열의 인덱스를 리턴
		ArrayList<Integer> index = new ArrayList<Integer>();
		for(int i=0;i<data.length;i++){
